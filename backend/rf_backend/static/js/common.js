...
function updateHeaderNav() {
    ...
    const loginLi = navUl.querySelector('a[href*="user-login"]')?.closest('li');
    const profileLi = navUl.querySelector('a[href*="my-profile"]')?.closest('li');
    ...
    if (isLoggedIn) {
        ...
        if (isAdmin) {
            ...
            adminLi.innerHTML = '<a href="/admin-panel/" id="admin-link" class="nav-link">Admin Panel</a>';
        ...
        logoutLi.innerHTML = '<a href="/user-login/" id="logout-link" class="nav-link">Logout</a>';
